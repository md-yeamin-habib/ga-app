...
import com.gaapp.dto.GenerationDTO;
...
public class GAService {
    ...
    public List<GenerationDTO> run(GARequest req) {
        ...
        for (int i = 0; i < history.size(); i++) {
                dtoList.add(toDTO(history.get(i), i, req.getSelectionType()));
        }
        
        return dtoList;
    }

    private GenerationDTO toDTO(GenerationResult gen, int index, String selectionType) {
